...
public class TOutIndBaseInfoGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		StringBuffer hql = new StringBuffer("from TOutIndBaseInfo t where 1=1 ");
		...
		if(StringUtils.hasText(fdDate)){
			...
			hql.append(" and rowDate between to_date('"+laststr+"','yyyy-mm-dd') and to_date('"+nowstr+"','yyyy-mm-dd')");
		}
