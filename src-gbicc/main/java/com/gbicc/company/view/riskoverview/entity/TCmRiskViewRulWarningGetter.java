...
public class TCmRiskViewRulWarningGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		StringBuffer hql = new StringBuffer("from TCmRiskViewRulWarning t where 1=1 ");
...
//		}
		...
		if(flag!=null){
			if(StringUtils.hasText(customerNum)){
				hql.append(" and customerId = '"+customerNum+"'  order by warnDt desc ");
			}else{
				hql.append(" and 1=0 ");
			}
			if(flag.equals("true")){
