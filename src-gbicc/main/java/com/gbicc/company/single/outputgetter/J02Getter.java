...
import com.gbicc.company.single.outputentity.J02;
...
public class J02Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_j02_customer_c where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<J02> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),J02.class);
		//构造数据量
