...
<@CommonQueryMacro.page title="任务管理  &gt; 预警清单工作台">
	<@CommonQueryMacro.CommonQuery id="WarningEntry" init="false" submitMode="current">
		<@CommonQueryMacro.DataTable   id="taskTable" paginationbar="moreHandle,-,btShow"   fieldStr="custCode[100],ruleLevel[80],custName[100],loanAccount[120],productName[180],loanPeriod[80],operator[100],operBank[120],createDate[100],staChangeDate[100],isNewCustomer[60]" width="100%" hasFrame="true"/>
