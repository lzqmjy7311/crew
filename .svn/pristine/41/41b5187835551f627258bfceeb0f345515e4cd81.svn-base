...
<@CommonQueryMacro.CommonQuery id="TCwFinancialValMonitor" init="false" submitMode="current">
			...
			<@CommonQueryMacro.DataTable id="datatable1" paginationbar="" maxRow="3" fieldStr="INDEX_NAME,INDUSTRY_NAME,INDUSTRY_TYPE,MONITOR_FRE,50%分位{NOW_VAL_4|TOP_VAL_4|YC_VAL_4|NY_VAL|opr}"  width="100%" hasFrame="true"/>
