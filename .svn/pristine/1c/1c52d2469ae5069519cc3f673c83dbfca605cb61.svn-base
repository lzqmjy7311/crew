...
import com.gbicc.company.single.outputentity.L03;
...
public class L03Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l03_ind_punish_detail where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L03> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L03.class);
		//构造数据量
