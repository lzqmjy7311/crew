...
/**
 * TPlQualitysupQuerytemp generated by hbm2java
 */
public class TPlQualitysupQuerytemp  implements java.io.Serializable {
    ...
    */
    ...
    /*
    */
    private Timestamp taskCreatDate;
    /*
    */
    private Timestamp completeDate;

    public TPlQualitysupQuerytemp() {
    }
    ...
    public Timestamp getTaskCreatDate() {
        return this.taskCreatDate;
    }
    
    public void setTaskCreatDate(Timestamp taskCreatDate) {
