...
import com.gbicc.company.single.outputentity.C12;
...
public class C12Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c12_draft_log where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C12> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C12.class);
		//构造数据量
