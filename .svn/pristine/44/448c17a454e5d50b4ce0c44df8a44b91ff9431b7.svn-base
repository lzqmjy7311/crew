...
/**
 * The persistent class for the T_ODS_EDW_DEPOSIT_ACCT_TXN_DTL_INFO database table.
 * 
 */
public class TOdsEdwDepositAcctTxnDtlInfotemp implements Serializable {
	...
	public TOdsEdwDepositAcctTxnDtlInfotemp() {
	}
