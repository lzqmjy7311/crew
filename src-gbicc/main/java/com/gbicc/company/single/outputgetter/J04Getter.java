...
import com.gbicc.company.single.outputentity.J04;
...
public class J04Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_j04_customer_p where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<J04> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),J04.class);
		//构造数据量
