...
import com.gbicc.company.single.outputentity.L04;
...
public class L04Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l04_cou_notice_detail where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L04> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L04.class);
		//构造数据量
