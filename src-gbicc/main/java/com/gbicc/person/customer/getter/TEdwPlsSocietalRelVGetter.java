...
public class TEdwPlsSocietalRelVGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		String loanAccount = (String) getCommQueryServletRequest().getParameterMap()
				.get("loanAccount");
		String custId = (String) getCommQueryServletRequest().getParameterMap()
				.get("custCode");
		...
		StringBuffer hql = new StringBuffer("from TEdwPlsSocietalRelV t where 1=1 ");
