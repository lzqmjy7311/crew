...
import com.gbicc.company.single.outputentity.C05;
...
public class C05Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c05_buy_contract where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C05> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C05.class);
		//构造数据量
