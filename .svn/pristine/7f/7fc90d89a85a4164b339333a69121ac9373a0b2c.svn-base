...
import com.gbicc.company.single.outputentity.C03;
...
public class C03Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c03_contract where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C03> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C03.class);
		//构造数据量
