...
public class ImportpersonGetter extends BaseGetter{
	@Override
	...
	protected PageQueryResult getData() throws Exception {
		...
		StringBuffer hql=new StringBuffer("from Importpersontext t where 1=1");			
		...
		String middleSigncode = (String) getCommQueryServletRequest().getParameterMap().get("name");
		String cardType = (String) getCommQueryServletRequest().getParameterMap().get("cardType");
		String cardNo = (String) getCommQueryServletRequest().getParameterMap().get("cardNo");
		...
		if(StringUtils.hasText(cardType)){
			hql.append(" and cardType = '"+cardType+"'");
		}
