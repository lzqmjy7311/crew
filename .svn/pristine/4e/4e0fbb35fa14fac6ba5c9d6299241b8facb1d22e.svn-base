...
import com.gbicc.company.single.outputentity.C11;
...
public class C11Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c11_endorsement_info where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C11> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C11.class);
		//构造数据量
