...
public class TPlDqReportJyGuarantGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		StringBuffer hql = new StringBuffer("from TPlDqReportJyGuarant t where 1=1 and businessid='"+businessId+"' ");
