...
public class TWdataTestGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String relaId = (String) getCommQueryServletRequest().getParameterMap()
				.get("relaId");
		String typeId = (String) getCommQueryServletRequest().getParameterMap()
				.get("typeId");
		...
		StringBuffer hql = new StringBuffer("from TOutCouJudgmentDetail t where 1=1 ");
