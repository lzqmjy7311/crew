...
import com.gbicc.company.single.outputentity.C08;
...
public class C08Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c08_depot_manage_list where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C08> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C08.class);
		//构造数据量
