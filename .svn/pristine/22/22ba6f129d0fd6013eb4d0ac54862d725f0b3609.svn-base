...
public class TCollectionInfoSelectGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		if(StringUtils.hasText(id)){
			...
			if("333".equals(info.getWorkflowRoleId())){
				hql.append(" and (operator = '"+info.getTlrno()+"' or operBank ='"+info.getBrcode()+"' )  ");
			}else{
				hql.append(" and operator = '"+info.getTlrno()+"' and operBank='"+info.getBrcode()+"'  ");
			}
		}
