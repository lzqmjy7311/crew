...
public class TOdsOutEiaIllInfoGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		StringBuffer hql = new StringBuffer("from TOdsOutEiaIllInfoId t where 1=1 ");
		if(StringUtils.hasText(id)){
			hql.append(" and id = '"+id+"'");
		}
		hql.append("order by INTEGER(id)");
