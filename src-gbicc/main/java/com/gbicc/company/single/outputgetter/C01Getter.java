...
import com.gbicc.company.single.outputentity.C01;
...
public class C01Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c01_borr_summary where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C01> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C01.class);
		//构造数据量
