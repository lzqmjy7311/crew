...
import com.gbicc.company.single.outputentity.L01;
...
public class L01Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l01_ind_base_info where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L01> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L01.class);
		//构造数据量
