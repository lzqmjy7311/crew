...
import com.gbicc.company.single.outputentity.J17;
...
public class J17Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_j17_subcontract where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<J17> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),J17.class);
		//构造数据量
