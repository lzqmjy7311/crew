...
import com.gbicc.company.single.outputentity.J18;
...
public class J18Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_j18_corporation where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<J18> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),J18.class);
		//构造数据量
