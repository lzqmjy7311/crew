...
<@CommonQueryMacro.page title="任务管理  &gt; 监控任务查询">
	<@CommonQueryMacro.CommonQuery id="QualitySup" init="false" submitMode="current">
			<div style="margin: 0 0px 0 0">
				<@CommonQueryMacro.Interface id="qalityquery" label="质量监督查询" colNm="4" showButton="false"/>
			</div>
			<center>
				<@CommonQueryMacro.Button id="btQuery"/>
				<@CommonQueryMacro.SimpleButton id="btnReset" desc="重置" icon="icon-reload" />
			</center>
			<@CommonQueryMacro.DataTable id="QualityTable" title="查询结果"  fieldStr="loanAcct[150],warningLevel,custName,loanVariety[200],loanAmt,loanBalance,loanTerm,handler,bankname[200],taskType,taskCreatDate,completeDate" width="100%" hasFrame="true"/>
