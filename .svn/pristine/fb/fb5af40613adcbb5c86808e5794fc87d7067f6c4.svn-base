...
import com.gbicc.company.single.outputentity.J09;
...
public class J09Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_j09_emp where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<J09> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),J09.class);
		//构造数据量
