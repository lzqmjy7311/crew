...
import com.gbicc.company.single.outputentity.C13;
...
public class C13Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c13_corp_affiliated where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C13> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C13.class);
		//构造数据量
