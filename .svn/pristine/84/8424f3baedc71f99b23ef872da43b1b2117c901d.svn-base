...
import com.gbicc.company.single.outputentity.L12;
...
public class L12Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l12_person_credit_index where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L12> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L12.class);
		//构造数据量
