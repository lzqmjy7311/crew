...
Integer ejhzCheckTask=service.getCount("ejhzCheckTask");
Integer ejhzPassTask=service.getCount("ejhzPassTask");
Integer ejhzBackTask=service.getCount("ejhzBackTask");
%>
</head>
<body class="bm">
...
<a href="javascript:void(0);" onclick="doWork('4','审核退回','/gbicc-pages/regular/ftl/monitor_report_desk_list.ftl?type=ejhzBackTask')" >审核退回：<%=ejhzBackTask%></a> 
<a href="javascript:void(0);" onclick="doWork('5','审核中','/gbicc-pages/regular/ftl/monitor_report_desk_list.ftl?type=ejhzCheckTask')" >审核中：<%=ejhzCheckTask%></a>
<a href="javascript:void(0);" onclick="doWork('6','审核通过','/gbicc-pages/regular/ftl/monitor_report_desk_list.ftl?type=ejhzPassTask')" >审核通过：<%=ejhzPassTask%></a>
</body>
</html>