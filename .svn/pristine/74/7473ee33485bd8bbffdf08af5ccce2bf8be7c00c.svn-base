...
<@CommonQueryMacro.DynamicTabSet id="resourceMonitor_tabs" hasMenu="false" height="400px" selected="sysTab">
	...
	<@CommonQueryMacro.DynamicTab id="jcrwpfTab" title="检查任务分派处理" url="/gbicc-pages/bpm/ftl/loan_account_duty_distribute_task.ftl">
	</@CommonQueryMacro.DynamicTab>
	<@CommonQueryMacro.DynamicTab id="csrwpfTab" title="催收任务分派处理" url="/gbicc-pages/bpm/ftl/loan_account_coll_distribute_task.ftl">
	</@CommonQueryMacro.DynamicTab>
	<!--
	<@CommonQueryMacro.DynamicTab id="rwzyTab" title="任务转移/重分配审核" url="/gbicc-pages/bpm/ftl/task_divert_apl.ftl">
	</@CommonQueryMacro.DynamicTab>-->
