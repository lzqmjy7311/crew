...
<@CommonQueryMacro.page title="我参与的流程  &gt;  我参与的流程">
	<@CommonQueryMacro.CommonQuery id="MyProcessHistory" init="true" submitMode="current">
   		<@CommonQueryMacro.Interface id="intface1111" label="请输入查询条件" showButton="false" labelwidth="100" colNm=8/>
   		<div align="center" style="margin-bottom:10px">
			<@CommonQueryMacro.InterfaceButton desc="查询" />
			<@CommonQueryMacro.SimpleButton id="btnReset" desc="重置" icon="icon-reload" />
		</div>
		<@CommonQueryMacro.DataTable id="MyProcessHistoryTable" readonly="true" paginationbar="btnRead" 
	...
	resize="true" minimize="false" width="1000" height="500" maximize="true" closure="true" show="false" defaultZoom="normal">
		<@CommonQueryMacro.CommonQuery id="TaskApprovalHistory" init="true" submitMode="all">
			<@CommonQueryMacro.DataTable id="taskApprovalHistoryTable" height="460"
...
<script>
	...
	function btnReset_onClick(){
		MyProcessHistory_interface_dataset.clearData();
	}
	function btnRead_onClick(){
		var businessId=MyProcessHistory_dataset.getValue("businessId");
