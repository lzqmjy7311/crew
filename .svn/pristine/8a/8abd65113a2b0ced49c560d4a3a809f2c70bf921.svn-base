...
import com.gbicc.company.single.outputentity.L02;
...
public class L02Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l02_ind_change_detail where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L02> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L02.class);
		//构造数据量
