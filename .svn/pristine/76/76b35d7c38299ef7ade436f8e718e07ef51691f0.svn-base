...
import com.gbicc.company.single.outputentity.L14;
...
public class L14Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l14_blacklist_info where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L14> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L14.class);
		//构造数据量
