...
import com.gbicc.company.single.outputentity.C14;
...
public class C14Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c14_corp_gcircle where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C14> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C14.class);
		//构造数据量
