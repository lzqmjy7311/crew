...
public final class RoleIndustryTreeNode extends TreeNode implements Comparable<RoleIndustryTreeNode> {
	...
	public RoleIndustryTreeNode() {
	}

	public RoleIndustryTreeNode(IndustryInfo fi) {
	...
	public IndustryInfo toIndustryInfo() {
		IndustryInfo re = new IndustryInfo();
		re.setId(this.getId());
	...
	public int compareTo(RoleIndustryTreeNode o) {
