...
public class TcRelevanceGetter extends BaseGetter {
...
//		" on dtl.FD_TASK_DIVERT_ID=d.FD_ID where d.FD_STATUS='"+TaskAfreshAssignOperation.STATUS+"')) ";
		...
		for(Object[] obj:list){
			Map<String,String> map=new HashMap<String, String>();
 			...
 			map.put("businessLicenseNum",obj[3]!=null ? obj[3].toString() : "");
 			map.put("registeredCapital",obj[4].toString());
 			map.put("foundedDate",obj[0].toString());
