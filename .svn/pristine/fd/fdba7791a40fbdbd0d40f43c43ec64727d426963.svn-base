...
import com.gbicc.company.single.outputentity.C02;
...
public class C02Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_c02_borr_account_list_info where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C02> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C02.class);
		//构造数据量
