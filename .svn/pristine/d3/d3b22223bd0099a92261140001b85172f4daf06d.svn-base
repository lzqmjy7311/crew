...
/**
 * This is an object that contains data related to the SYS_TASK_INFO table.
...
public abstract class BaseSysTaskInfo  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof SysTaskInfo)) return false;
		else {
			SysTaskInfo sysTaskInfo = (SysTaskInfo) obj;
			if (null == this.getId() || null == sysTaskInfo.getId()) return false;
			else return (this.getId().equals(sysTaskInfo.getId()));
		}
	}
