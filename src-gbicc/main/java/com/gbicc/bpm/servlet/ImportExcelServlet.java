...
//							rowlist.add(cell.getNumericCellValue());
	 				...
	 				String iparent = null;String itype=null;String iname=null;String color="'LV2'";
	...
	public static void main(String args[]){
		try {
			URL url= new URL("http://www.qixianzhi.com/login/selectCustomPwd?customId=wangshaoping@gbicc.net&customPwd=qwe123");
			...
			url= new URL("http://www.qixianzhi.com/esEntprs/getEntDetailjt1.do?keyid=ec6777717fb44077a0a8f1a73f4adb9c");
			connect=(HttpURLConnection) url.openConnection();
			connect.addRequestProperty("Cookie", cookie);
			...
			is.close();
			System.out.println("=====================");
			File temWeb=new File("E:/temWeb.html");
			FileWriter fw=new FileWriter(temWeb);
			fw.write(abc.toString());
