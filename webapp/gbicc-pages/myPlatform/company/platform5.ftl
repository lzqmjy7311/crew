...
<@CommonQueryMacro.PortalWin id="poralwin1" cookied="false" >
   <@CommonQueryMacro.PortalGroup width="800">
	   ...
	   <@CommonQueryMacro.Portal id="2"  collapsible="false"  title="任务总览" height="60" url="/gbicc-pages/myPlatform/company/task_total_5.jsp" />
	   <@CommonQueryMacro.Portal id="3" title="我的工作台" height="620" include="false" collapsible="false" url="/gbicc-pages/myPlatform/company/task_tab5.ftl" />
