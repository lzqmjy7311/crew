...
import com.gbicc.company.single.operation.TCmSingleRulCasesMngOperation;
...
public class TCmSingleRulCasesMngUpdate extends BaseUpdate {
	...
	public UpdateReturnBean saveOrUpdate(MultiUpdateResultBean arg0,
		...
		try {
			...
			OPCaller.call(TCmSingleRulCasesMngOperation.ID, oc);
