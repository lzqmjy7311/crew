...
public class TPlDqReportJyPartnerGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		StringBuffer hql = new StringBuffer("from TPlDqReportJyPartner t where 1=1 and businessid='"+businessId+"' ");
