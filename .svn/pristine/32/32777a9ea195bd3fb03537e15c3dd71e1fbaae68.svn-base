...
import com.gbicc.company.single.outputentity.A38;
...
public class A38Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_a38_bgdf where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<A38> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),A38.class);
		//构造数据量
