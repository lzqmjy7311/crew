...
public class TCmSingleRulCasesOperation extends BaseOperation {
	...
	public static final String OP_SAVE="save";//案例保存
	...
	public void execute(OperationContext context) throws CommonException {
		...
		try {
			if(!op.equals(OP_SAVE)){
				taskComplete(op,cases,opinion,userId);
	...
	public void taskComplete(String op,TCmSingleRulCases cases,String opinion,String checkerId) throws Exception{
