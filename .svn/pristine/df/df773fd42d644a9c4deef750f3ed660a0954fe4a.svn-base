	...
	<tr>
		<td>
			<@CommonQueryMacro.GroupBox id="SingleRulInvestigationBox" label="协查任务信息" expand="true">
					...
					协查任务说明：<a id="fupload" href="javascript:void()">浏览（<font id="Nums1"></font>）</a>
			</@CommonQueryMacro.GroupBox>
		</td>
	</tr>
	<tr>
		<td>
			<@CommonQueryMacro.GroupBox id="SingleRulInvestigationBox2" label="任务核查情况" expand="true">
					...
					协查反馈报告：<a id="fupload2" href="javascript:void()">浏览（<font id="Nums2"></font>）</a>
			</@CommonQueryMacro.GroupBox>
		</td>
	</tr>
	</@CommonQueryMacro.CommonQuery>
...
<script>
	...
	function btnShow_onClick(){
		...
		if(businessId!=null && businessId!=""){
			parent.parent.parent.GTab.addTab('SingleRulWarning',"详细信息",'/gbicc-com-pages/single/ftl/single_rul_warning_info.ftl?businessId='+businessId);
		}
	};
