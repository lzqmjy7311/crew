...
/**
 * This is an object that contains data related to the SYS_TASK_LOG table.
...
public abstract class BaseSysTaskLog  implements Serializable {
	 ...
	 * @param intOperId the INT_OPER_ID value
	 */
	 ...
	 * @param intInsId the INT_INS_ID value
	 */
	 ...
	 * @param adtRcdPk the ADT_RCD_PK value
	 */
	 ...
	 * @param updTransCd the UPD_TRANS_CD value
	 */
	 ...
	 * @param newVal1 the NEW_VAL1 value
	 */
	 ...
	 * @param newVal2 the NEW_VAL2 value
	 */
	 ...
	 * @param approveOperId the APPROVE_OPER_ID value
	 */
	 ...
	 * @param approveInsCd the APPROVE_INS_CD value
	 */
	 ...
	 * @param approveTm the APPROVE_TM value
	 */
	 ...
	 * @param oldVal1 the OLD_VAL1 value
	 */
	 ...
	 * @param oldVal2 the OLD_VAL2 value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof SysTaskLog)) return false;
		else {
			SysTaskLog sysTaskLog = (SysTaskLog) obj;
			if (null == this.getId() || null == sysTaskLog.getId()) return false;
			else return (this.getId().equals(sysTaskLog.getId()));
		}
	}
