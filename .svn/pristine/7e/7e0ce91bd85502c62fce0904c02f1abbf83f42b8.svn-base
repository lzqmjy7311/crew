...
import com.huateng.ebank.business.approve.service.UndoConfirmService;
...
public class UndoConfirmGetter extends BaseGetter {
	...
	private PageQueryResult getData(List codesList) throws AppException {
		...
		// 组装hql语句
		StringBuffer hql = new StringBuffer("from SysTaskInfo dd where 1=1 and dd.insCd='00001'");
