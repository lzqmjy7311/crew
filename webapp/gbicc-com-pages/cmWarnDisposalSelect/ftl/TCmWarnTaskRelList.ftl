...
<table width="100%">
	...
	<tr>
		<td colspan="2">
			<@CommonQueryMacro.DataTable id="datatable1" paginationbar="btHandle" fieldStr="taskCode,taskType,warnCunt,status,taskCreatDate,taskMatureDate,taskOverran"  width="100%" hasFrame="true"/>
		</td>
	</tr>
		<tr>
      	<td colspan="2">
