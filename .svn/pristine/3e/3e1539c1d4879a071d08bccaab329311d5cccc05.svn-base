...
import com.gbicc.company.single.outputentity.L15;
...
public class L15Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l15_eia_ill_info where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L15> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L15.class);
		//构造数据量
