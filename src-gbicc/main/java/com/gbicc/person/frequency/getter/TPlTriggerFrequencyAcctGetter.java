...
//		String brcode = (String) getCommQueryServletRequest().getParameterMap().get("orgId");
        ...
        sql.append(" B.FD_LAUNCHPER launchPer,B.FD_LAUNCHP_BANK launchBank,B.FD_SYS_FREQUENCY sysFrequency  FROM 　T_PL_TRIGGER_FREQUENCY_ACCT B LEFT JOIN T_EDW_PLS_ACCOUNT_V ACC ON B.FD_LOAN_ACCT=ACC.LOANACNO  where 1=1");
		...
		//排除产品为（组合） 已结清 
		    sql.append(" AND ACC.PAYOFFFLAG='00' AND ACC.PRODID NOT IN ('93010200','96010200','96010100','93010100') ");
