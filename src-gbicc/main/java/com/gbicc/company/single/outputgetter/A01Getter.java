...
import com.gbicc.company.single.outputentity.A01;
...
public class A01Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_a01_deposit_acct_txn_dtl_info where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<A01> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),A01.class);
		//构造数据量
