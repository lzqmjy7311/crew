...
function selectIndexReport1(codeVal,ORG_CODE,ORG_NAME,GATHER_TYPE){
	parent.parent.GTab.addTab("selectCustomerWin"+ORG_CODE,"信贷资产监测指标展示_机构_"+ORG_NAME,"/gbicc-report-pages/combinationWarn/ftl/TCwIndexOrgReport.ftl?INDEX_CODE="+codeVal+"&GATHER_TYPE="+GATHER_TYPE+"&ORG_CODE="+ORG_CODE);
}
...
function selectIndexReport2(codeVal,PRODUCT_CODE,PRODUCT_NAME,GATHER_TYPE,ORG_CODE){
	openSubWin("selectCustomerWin"+PRODUCT_CODE,"信贷资产监测指标展示_产品_"+PRODUCT_NAME,"/gbicc-report-pages/combinationWarn/ftl/TCwIndexProductReport.ftl?INDEX_CODE="+codeVal+"&GATHER_TYPE="+GATHER_TYPE+"&PRODUCT_CODE="+PRODUCT_CODE+"&ORG_CODE="+ORG_CODE,"1200","450");
}
...
function selectIndexReport3(codeVal,INDUSTRY_CODE,GATHER_TYPE,ORG_CODE){
	parent.parent.GTab.addTab("selectCustomerWin"+INDUSTRY_CODE,"信贷资产监测指标展示_行业_"+INDUSTRY_NAME,"/gbicc-report-pages/combinationWarn/ftl/TCwIndexIndustryReport.ftl?INDEX_CODE="+codeVal+"&GATHER_TYPE="+GATHER_TYPE+"&INDUSTRY_CODE="+INDUSTRY_CODE+"&ORG_CODE="+ORG_CODE);
}
...
function initCallGetter_post(){
	...
	TCwIndexORG_dataset.setParameter("GATHER_TYPE","2");
	...
	TCwIndexPRODUCT_dataset.setParameter("GATHER_TYPE","2");
	...
	TCwIndexINDUSTRY_dataset.setParameter("GATHER_TYPE","2");
