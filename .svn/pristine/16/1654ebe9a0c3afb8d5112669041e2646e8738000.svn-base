...
<@CommonQueryMacro.SimpleButton id="b4" desc="刷新" />
<@CommonQueryMacro.SimpleButton id="b1" desc="勾选全选" />
<@CommonQueryMacro.SimpleButton id="b2" desc="反选全部" />
<@CommonQueryMacro.SimpleButton id="b12" desc="勾选选中节点" />
<@CommonQueryMacro.SimpleButton id="b22" desc="反选选中节点" />
<@CommonQueryMacro.SimpleButton id="b61" desc="勾选一个节点:Node111" />
<@CommonQueryMacro.SimpleButton id="b62" desc="勾选多个节点:Node1111, Node1112, Node1114" />
<hr/>
<@CommonQueryMacro.SimpleButton id="b31" desc="获取Checked节点" />
<@CommonQueryMacro.SimpleButton id="b32" desc="获取UnChecked节点" />
<@CommonQueryMacro.SimpleButton id="b33" desc="获取Indeterminate节点" />
<hr/> 
<@CommonQueryMacro.SimpleButton id="b51" desc="折叠全部" />
<@CommonQueryMacro.SimpleButton id="b52" desc="折叠选中的节点" />
<@CommonQueryMacro.SimpleButton id="b53" desc="展开全部" />
<@CommonQueryMacro.SimpleButton id="b54" desc="展开选中的节点" />
<@CommonQueryMacro.SimpleButton id="b55" desc="定位到Node111" />
<hr/>
<@CommonQueryMacro.SimpleButton id="b71" desc="追加节点" />
<@CommonQueryMacro.SimpleButton id="b72" desc="删除节点" />
<div id="dd">
</div>
</div>
