...
<@CommonQueryMacro.DynamicTabSet id="demotab" hasMenu="true" height="720" fit="true" selected="t1">
			        <@CommonQueryMacro.DynamicTab id="t1" title="资产质量指标" url="/gbicc-report-pages/combinationWarn/ftl/TCwCreditAssetsMonitor1.ftl?indexType=T4&gatherType=0"> 
			        </@CommonQueryMacro.DynamicTab>
			        <@CommonQueryMacro.DynamicTab id="t2" title="集中度指标" url="/gbicc-report-pages/combinationWarn/ftl/TCwCreditAssetsMonitor2.ftl?indexType=T1&gatherType=1"> 
			        </@CommonQueryMacro.DynamicTab>
			        <@CommonQueryMacro.DynamicTab id="t3" title="减值拨备指标" url="/gbicc-report-pages/combinationWarn/ftl/TCwCreditAssetsMonitor0.ftl?indexType=T3&gatherType=0"> 
			        </@CommonQueryMacro.DynamicTab>
