...
import com.gbicc.company.single.outputentity.C09;
...
public class C09Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from T_REW_C09_DRAFT_INFO where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C09> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C09.class);
		//构造数据量
