...
public class TOutCouNoticeDetailGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		StringBuffer hql = new StringBuffer("from TOutCouNoticeDetail where 1=1 ");
		...
		if(StringUtils.hasText(fdDate)){
			...
			hql.append(" and tryDate BETWEEN to_date('"+laststr+"','yyyy-mm-dd') and to_date('"+nowstr+"','yyyy-mm-dd')");
		}
