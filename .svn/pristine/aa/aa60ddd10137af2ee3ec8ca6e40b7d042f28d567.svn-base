...
<@CommonQueryMacro.page title="流程管理  &gt;  任务调查">
	<@CommonQueryMacro.CommonQuery id="TaskEntry" init="false" submitMode="current">
		...
		fieldStr="warnLevel[80],loanAcct[150],custName,loanVariety[180],loanAmt,loanBalance,loanTerm,rptStatus[150],taskType[100],taskCreatDate[90],taskMatureDate[90],handler,currentUserName,ifTimeout" width="100%" hasFrame="true"/>
	...
	function initCallGetter_post(){
		...
		TaskEntry_dataset.setParameter("type","overTask");
		//TaskEntry_dataset.setParameter("warnLevel","6");//默认查询6级
	...
	function btHandle_onClick(){
		...
		//}
		path=path+"&pageReadOnly=1";
	    ajMonitorReportWin=openSubWin("ajMonitorReportWixn",title,reportUrl+"?businessId="+businessId+"&rptStatus="+rptStatus,"1000","700");
	}
	</script>
