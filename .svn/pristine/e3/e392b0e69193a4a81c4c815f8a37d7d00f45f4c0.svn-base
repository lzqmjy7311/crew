...
import com.gbicc.company.single.outputentity.C15;
...
public class C15Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select I.*,I.LAST2_M_SAL_AMOUNT AS lastTwoMSalAmount,I.LAST3_M_SAL_AMOUNT AS lastThreeMSalAmount,I.LAST2_M_PUB_AMOUNT AS lastTwoMPubAmount,I.LAST3_M_PUB_AMOUNT AS lastThreeMPubAmount from T_REW_C15_CORP_INDEX I where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<C15> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),C15.class);
		//构造数据量
