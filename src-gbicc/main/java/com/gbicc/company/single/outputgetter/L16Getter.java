...
import com.gbicc.company.single.outputentity.L16;
...
public class L16Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from T_REW_L16_COMPANY_CREDIT_LOANINFO where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L16> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L16.class);
		//构造数据量
