...
Integer checkTask=service.getCount("checkTask");
Integer passTask=service.getCount("passTask");
Integer backTask=service.getCount("backTask");
%>
</head>
<body class="bm">
...
<a href="javascript:void(0);" onclick="doWork('4','审核退回','/gbicc-pages/regular/ftl/monitor_report_desk_list.ftl?type=backTask')" >审核退回：<%=backTask%></a> 
<a href="javascript:void(0);" onclick="doWork('5','审核中','/gbicc-pages/regular/ftl/monitor_report_desk_list.ftl?type=checkTask')" >审核中：<%=checkTask%></a>
<a href="javascript:void(0);" onclick="doWork('6','审核通过','/gbicc-pages/regular/ftl/monitor_report_desk_list.ftl?type=passTask')" >审核通过：<%=passTask%></a>
