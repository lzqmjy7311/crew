...
import com.gbicc.company.single.outputentity.J16;
...
public class J16Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_j16_tbassetacc where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<J16> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),J16.class);
		//构造数据量
