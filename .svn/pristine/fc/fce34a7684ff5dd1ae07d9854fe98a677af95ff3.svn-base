...
public class TPlDqReportJyCreditBusinGetter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		StringBuffer hql = new StringBuffer("from TPlDqReportJyCreditBusin t where 1=1 and businessid='"+businessId+"' ");
