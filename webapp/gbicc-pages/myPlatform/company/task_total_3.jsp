...
<body class="bm">
<a href="javascript:void(0);" onclick="parent.doWork('1','待办单规则预警任务','/gbicc-com-pages/single/ftl/single_rul_warning_task.ftl')" >待办单规则预警任务：<%=RULE_TYPE_TODO %></a>
<a href="javascript:void(0);" onclick="parent.doWork('2','超时单规则预警任务','/gbicc-com-pages/single/ftl/single_rul_warning_task.ftl?taskType=overTask')" >超时单规则预警任务：<%=RULE_TYPE_OVER %></a> 
