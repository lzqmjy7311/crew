...
import com.gbicc.company.single.outputentity.L05;
...
public class L05Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l05_cou_judgment_detail where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L05> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L05.class);
		//构造数据量
