...
import com.gbicc.company.single.outputentity.L13;
...
public class L13Getter extends BaseGetter {
	...
	protected PageQueryResult getData() throws Exception {
		...
		String sql="select * from t_rew_l13_person_importpublic_table where 1=1 and fd_warn_id='"+warningId+"' ";
		...
		List<L13> resultList=CommonService.getInstance().findSqlListBySpringJdbc(sqlp.toString(),L13.class);
		//构造数据量
